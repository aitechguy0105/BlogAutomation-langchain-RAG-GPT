...
class UserModel(db.Model):
    ...
    is_subscribe = db.Column(db.Boolean, nullable=False, default=True)
    ...
    def __init__(self, data):
        ...
        # self.blogposts = db.relationship('BlogpostModel', backref='users', lazy=True,uselist=True)  # add this new line
        self.role = data.get('role')
        self.is_subscribe = data.get('is_subscribe')
    def save(self):
        db.session.add(self)
        db.session.commit()
